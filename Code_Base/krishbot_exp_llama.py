...
ROOT_FOLDER = Path('C:\\Users\\LAB-USER\\Desktop\\SecureNote\\data_store')
...
NOTES_FOLDER = Path("C:\\Users\\LAB-USER\\Desktop\\SecureNote\\Notes")
...
def conversation(qa_chain, message):
    ...
    if selected:
        ...
        similar_docs = [doc for doc in all_docs if os.path.basename(doc.metadata.get("source", "")) in selected][:8]
    else:
        similar_docs = []
